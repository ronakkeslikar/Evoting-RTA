...
namespace evoting.Domain.Models
{
    public class FJC_Registration
    {
        ...
        [Required (ErrorMessage ="Enter Entity Name") ,RegularExpression(@"^[a-zA-Z0-9 -,_]*$",ErrorMessage = "Please enter valid Entity Name")] 
        public string name { get; set;}  

        //[Required (ErrorMessage ="Enter Reg. No.") ,RegularExpression(@"^[a-zA-Z0-9 -,_]*$")] 
        public string reg_no { get; set;}
                
        [Required (ErrorMessage ="Enter Registered Office Address") ,RegularExpression(@"^[a-zA-Z0-9 -,_]*$",ErrorMessage = "Please enter valid Registered Office Address")] 
        ...
        public string reg_city { get; set;}
         [Required (ErrorMessage ="Enter Pincode"),RegularExpression(@"^[0-9]*$",ErrorMessage = "Please enter valid Pincode")] 
        ...
        [Required (ErrorMessage ="Enter Correspondence Address") ,RegularExpression(@"^[a-zA-Z0-9 -,_]*$",ErrorMessage = "Please enter valid Correspondence Address")] 
        ...
        public string pcs_no { get; set;}
         [Required (ErrorMessage ="Enter NAME") ,RegularExpression(@"^[a-zA-Z0-9 -,_]*$",ErrorMessage = "Please enter valid NAME")] 
        public string cs_name { get; set;}
         [Required (ErrorMessage ="Enter EMAIL_ID") ,RegularExpression(@"^([\w\.\-]+)@([\w\-]+)((\.(\w){2,3})+)$",ErrorMessage = "Please enter valid EMAIL ID")]
        public string cs_email_id { get; set;}
        public string cs_alt_email_id { get; set;}
         [Required (ErrorMessage ="Enter Telephone No.") ,RegularExpression(@"^[0-9]*$",ErrorMessage = "Please enter valid Telephone No.")] 
        public string cs_tel_no { get; set;}
        public string cs_fax_no { get; set;}
        [Required (ErrorMessage ="Enter Mobile No.") ,RegularExpression(@"^[0-9]*$",ErrorMessage = "Please enter valid Mobile No.")] 
        public string cs_mobile_no { get; set;}
         
     [Required (ErrorMessage ="Enter PAN ID") ,RegularExpression(@"^[a-zA-Z0-9]*$",ErrorMessage = "Please enter valid PAN ID")] 
